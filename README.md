...
- [计算机网络体系结构](./docs/01.网络/QA.md#1-计算机网络体系结构)
- [UDP 的主要特点](./docs/01.网络/QA.md#2-udp-的主要特点)
- [TCP 的主要特点](./docs/01.网络/QA.md#3-tcp-的主要特点)
- [简述三报文握手建立 TCP 连接](./docs/01.网络/QA.md#4-简述三报文握手建立-tcp-连接)
- [建立 TCP 连接为什么最后还要发送确认](./docs/01.网络/QA.md#5-建立-tcp-连接为什么最后还要发送确认)
- [简述 TCP 连接的释放](./docs/01.网络/QA.md#6-简述-tcp-连接的释放)
- [TIME-WAIT 是什么，为什么必须等待 2MLS](./docs/01.网络/QA.md#7-time-wait-是什么为什么必须等待-2mls)
- [TCP 粘包问题](./docs/01.网络/QA.md#8-tcp-粘包问题)
- [UDP、TCP 区别，适用场景](./docs/01.网络/QA.md#9-udptcp-区别适用场景)
- [建立 socket 需要哪些步骤](./docs/01.网络/QA.md#10-建立-socket-需要哪些步骤)
- [DNS 主要作用是什么](./docs/01.网络/QA.md#11-dns-主要作用是什么)
- [HTTP 报文组成](./docs/01.网络/QA.md#12-http-报文组成)
- [HTTP 状态码](./docs/01.网络/QA.md#13-http-状态码)
- [常见的 HTTP 方法](./docs/01.网络/QA.md#14-常见的-http-方法)
- [GET 与 POST 请求方式区别](./docs/01.网络/QA.md#15-get-与-post-请求方式区别)
- [HTTP 优缺点](./docs/01.网络/QA.md#16-http-优缺点)
- [HTTPS 通信原理](./docs/01.网络/QA.md#17-https-通信原理)
- [HTTP 2.0](./docs/01.网络/QA.md#18-http-20)
- [WebSocket](./docs/01.网络/QA.md#19-websocket)
- [IPv6 与 IPv4 有什么变化](./docs/01.网络/QA.md#20-ipv6-与-ipv4-有什么变化)
- [什么是心跳机制](./docs/01.网络/QA.md#21-什么是心跳机制)
- [什么是长连接](./docs/01.网络/QA.md#22-什么是长连接)
